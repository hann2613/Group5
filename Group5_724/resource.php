    ...
    <header>
      <nav>
        ...
        <div class="icons">
          ...
          <a href="setup_team.php"
            ><button class="teamup-btn">Team Up</button></a
          >
      ...
      <div class="investor">
        ...
        <div class="investor-profile" key="<?php echo $investor['id']; ?>">
          <div class="resource-card">
            <img
              id="avatar"
              src="<?php echo htmlspecialchars($investor['avatar']); ?>"
              alt="img"
            />
            <p><?php echo htmlspecialchars($investor['name']); ?></p>
            <p>
              Expert in
              <?php echo htmlspecialchars($investor['field']); ?>
            </p>
          </div>
        </div>
        <?php endforeach; ?>
      ...
      <div class="funding">
        ...
        <div class="fundings-profile" key="<?php echo $funding['id']; ?>">
          <div class="resource-card">
            ...
            <p>
              Funding Amount:
              <?php echo htmlspecialchars($funding['amount']); ?>
            </p>
            <p>
              Investment Field:
              <?php echo htmlspecialchars($funding['field']); ?>
            </p>
            <p>
              Application Deadline:
              <?php echo htmlspecialchars($funding['deadline']); ?>
            </p>
          </div>
        </div>
        <?php endforeach; ?>
      ...
      <div class="supplier">
        ...
        <div class="supplier-profile" key="<?php echo $supplier['id']; ?>">
          <div class="resource-card">
            ...
            <p>
              Supplier Field:
              <?php echo htmlspecialchars($supplier['field']); ?>
            </p>
            <p>
              Supplier Country/Area:
